...
// 설정버튼 눌렀을 때
    ...
    public void alarm_on(){
        ...
        AlarmManager am = (AlarmManager)getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(getApplicationContext(), MyReceiver.class);   //AlarmReceive.class이클레스는 따로 만들꺼임 알람이 발동될때 동작하는 클레이스임
        ...
        calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DATE), 10,27);//시간을 10시 01분으로 일단 set했음
    ...
    public class AlarmHATT {
        ...
        public void Alarm() {
            ...
            calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DATE), 11, 5, 0);
